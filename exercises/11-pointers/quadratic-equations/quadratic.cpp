 ...
 * File: quadrratic.cpp
 * --------------------
 * The program finds roots of the quadratic equation
 *
 *      2
 *    ax   +   bx   +   c   =   0
 *
 * If a is 0 or if the equation has no real roots,
 ...
 * --------------------------------
 * Reads in the coefficients of a quadratic equations into the
...
void solveQuadratic(double a, double b, double c, double* x1, double* x2) {
    if (a == 0) error("The coefficients a must be nonzero");

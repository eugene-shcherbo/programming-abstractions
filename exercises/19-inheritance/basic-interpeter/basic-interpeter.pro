...
SOURCES *= "" \
    ...
    shape.cpp \
    shapelist.cpp \
    src/basicstatement.cpp \
    src/bigint.cpp \
    src/graphtypes.cpp \
    src/intarray.cpp \
    src/mystring.cpp \
    tictactoegame.cpp \
    twoplayergamebase.cpp
SOURCES = ""
...
# END OF FILE (this should be line #721; if not, your .pro has been changed!)

 ...
 * by displaying three different constants
 * (pi, the speed of light in meters/second and the fine-structure constant). These constants
...
constexpr double FINE_STRUCTURE{7.2573525E-3};

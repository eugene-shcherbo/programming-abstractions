...
int findAnagrams(const std::string& phrase, int max, const Set<std::string>& dictionary);   // written by you, in anagramsolver.cpp
...
int main() {
    std::cout << "Welcome to the CS 106X Anagram Solver!" << std::endl;
